...
//6 1000 ms		Sixt Request Allowed	(not 0) 1 tokens left  the startRefill function executes and adds on more token
...
//10 1800 ms	Tenth Request Denied	tokens left
