...
// PrformTask simulates a worker performing a task
...
func main() {
	...
	// Define Tasks to be performed by worker
...
// 	time.Sleep(time.Second) // Simulate some works
...
// ============ BASIC EXAMPLE WITHPUT USING CHANNELS
// func worker(id int, wg *sync.WaitGroup) {

// 	defer wg.Done()
// 	// wg.Add(1) // WRONG PRACTICE
// 	fmt.Printf("Worker %d starting\n", id)
// 	time.Sleep(time.Second) // simulate some time spent on proccessiing the task
