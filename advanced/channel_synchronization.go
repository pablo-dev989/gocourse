...
// ============ SYNCHRONIZED MULTIPLE GOROUTINES AND ENSURING THAT ALL GOROUTINES ARE COMPLETE
// func main() {
...
// 		<-done // Wait for each goroutines to finish, WAIT FOR ALL GOROUTINES TO SIGNAL COMPLETION
// 	}
...
func main() {
	...
	// close(data) // Clannel closed before Goroutine could send a value to the channel
